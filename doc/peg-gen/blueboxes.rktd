385
((3) 0 () 1 ((q lib "peg-gen/main.rkt")) () (h ! (equal) ((c def c (c (? . 0) q gen:grm)) q (448 . 8)) ((c def c (c (? . 0) q gen:expr)) q (745 . 7)) ((c def c (c (? . 0) q gen:peg)) q (269 . 5)) ((c def c (c (? . 0) q gen:symbolVar)) q (1043 . 3)) ((c def c (c (? . 0) q gen:Γ)) q (0 . 4)) ((c def c (c (? . 0) q gen:var)) q (964 . 3)) ((c def c (c (? . 0) q initΔ)) q (146 . 3))))
procedure
